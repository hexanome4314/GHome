...
\param	id	ID du capteur
	drv	Driver utilisé
*/
function edit_user_passwd( id, drv ) {
	var dialog_title = "";
	var drv_name ="";
...
*/
function save_user_passwd( old_driver, old_id, old_name ) {
...
\param	id	ID du capteur
	drv	Driver utilisé
*/
function confirm_remove_user( id, drv ) {
	...
	$.ajax( {
		async: false,
			...
			*/
			...
			str += '<div class="content" style="padding-bottom: 15px;">';
			str += '<div class="row"><div class="cell">';
			str += '<span>Port telnet :</span>';
			str += '</div><div class="cell">';
			str += '<input type="text" name="port_telnet" value="';
			str += $( data ).find( 'telnet' ).attr( 'port' );
			str += '" size="5" class="text"/>';
			str += '</div></div>';
			str += '<div class="row"><div class="cell">';
			...
			str += '<div class="content" style="padding-bottom: 15px; margin-top: 10px;">';
			str += '<div class="row"><div class="cell">';
			str += '<span>Port actionner :</span>';
			str += '</div><div class="cell">';
			str += '<input type="text" name="port_telnet" value="';
			str += $( data ).find( 'actionner' ).attr( 'port' );
			str += '" size="5" class="text" />';
			str += '</div></div></div>';

			str += '<div class="content" style="padding-bottom: 15px; margin-top: 10px;">';
			str += '<span style="margin-right: 20px;">Utilisateurs web :</span>';
			/*str += '<a href="#" class="tiny_link add"><span><img src="img/button/add.png" class="tiny_btn"/>Nouveau</span></a>';*/
			str += '<div class="user_list">';
			$( data ).find( 'user' ).each( function() {
				
				str += '<div class="row"><div class="cell">';

				str += '<span class="user_name"> &bull; ';
				...
				/*str += '<a href="#" class="tiny_link edit" user="' + $(this).attr( 'name' ) + '"><span><img src="img/button/edit.png" class="tiny_btn"/>Editer</span></a>'
				str += '<a href="#" class="tiny_link del"  user="' + $(this).attr( 'name' ) + '"><span><img src="img/button/delete.png" class="tiny_btn"/>Supprimer</span></a>'*/
