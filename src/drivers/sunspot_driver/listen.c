 ...
 * we get from SunSPOT Sensors into a sunspot_data_structure
 * \param the frame
 * \param a sunspot_data_structure where to put the information
 */
void parser(char* aFrame, sunspot_data_structure* aMessage){
...
void _interpretAndSendRPS(sunspot_data_structure* a_RPS_message, int* msgq_id){
	...
	msgsnd( (msgqnum_t)msgq_id, (const void*) &msg, sizeof(struct msg_drv_notify) - sizeof(long), 0 );
	msgsnd( (msgqnum_t)msgq_id, (const void*) &msg2, sizeof(struct msg_drv_notify) - sizeof(long), 0 );
	msgsnd( (msgqnum_t)msgq_id, (const void*) &msg3, sizeof(struct msg_drv_notify) - sizeof(long), 0 );
	msgsnd( (msgqnum_t)msgq_id, (const void*) &msg4, sizeof(struct msg_drv_notify) - sizeof(long), 0 );
}

void _interpretAndSend1BS(sunspot_data_structure* a_RPS_message, int* msgq_id){
...
void _interpretAndSend4BS(sunspot_data_structure* a_RPS_message, int* msgq_id){
	...
	msgsnd( (msgqnum_t)msgq_id, (const void*) &msgTemp, sizeof(struct msg_drv_notify) - sizeof(long), 0 );
	msgsnd( (msgqnum_t)msgq_id, (const void*) &msg2, sizeof(struct msg_drv_notify) - sizeof(long), 0 );
	msgsnd( (msgqnum_t)msgq_id, (const void*) &msg3, sizeof(struct msg_drv_notify) - sizeof(long), 0 );
}
